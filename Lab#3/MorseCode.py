...
# Since we only use Red and Blue, we have those two colors HEX value
...
def print_message():
    ...
    print ("|     based on Morse Code Message      |")
    print ("|                            SunFounder|")
    print ("========================================\n")
...
def setColor(color):
    # Divide colors from 'color' variable
...
def main():
    print_message()
    # Set color based on the dot, dash, and space
    # Red = dot, Blue with double time of dot = dash, Blue with 4 times of dot = space
    s = message.split()
